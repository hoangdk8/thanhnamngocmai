"use strict";
(self.webpackChunk_N_E = self.webpackChunk_N_E || []).push([[1270], {
    10810: (t, e, a) => {
        a.d(e, { j: () => o });
        var r = a(12115), s = a(35695);
        function o(t) {
            let { enabled: e } = t,
                [a, o] = (0, r.useState)(!1),
                [n, l] = (0, r.useState)(!1),
            ...
            let d = function () {
                let t = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : {},
                    { scrollSpeed: e = 20, startDelay: a = 2e3, enabled: s = !0, stopOnUserInteraction: o = !0 } = t,
                    n = (0, r.useRef)(void 0),
                    l = (0, r.useRef)(void 0),
                    i = (0, r.useRef)(void 0),
                    c = (0, r.useRef)(!1),
                ...
                return (0, r.useEffect)(() => {
                    ...
                    let t = new AbortController(),
                        ...
                        i = () => {
                            c.current
                                || (c.current = !0,
                                    void 0 !== n.current && (cancelAnimationFrame(n.current), n.current = void 0),
                                    t.abort());
                        },
                        m = t => {
                            if (c.current) return;
                            ...
                            void 0 === l.current && (l.current = t);
                            let a = (t - l.current) / 1e3 * e;
                            window.scrollTo(0, a);
                            let r = window.innerHeight, s = document.documentElement.scrollHeight;
                            if (window.scrollY + r >= s - 10) return void i();
                            n.current = requestAnimationFrame(m);
                        };
                    return p.current = m,
                        f.current = setTimeout(() => {
                            if (!c.current) {
                                if (o) {
                                    let t = { passive: !0, signal: r };
                                    window.addEventListener("wheel", i, t),
                                        window.addEventListener("touchstart", i, t),
                                        window.addEventListener("mousedown", i, { signal: r }),
                                        window.addEventListener("keydown", i, { signal: r });
                                }
                                n.current = requestAnimationFrame(m);
                            }
                        }, a),
                        () => {
                            void 0 !== f.current && (clearTimeout(f.current), f.current = void 0), i();
                        };
                }, [e, a, s, o]),
                {
                    pause: (0, r.useCallback)(() => {
                        d.current || c.current || (d.current = !0, i.current = window.scrollY);
                    }, []),
                    resume: (0, r.useCallback)(() => {
                        if (!d.current || c.current) return;
                        let t = window.scrollY / e * 1e3;
                        l.current = performance.now() - t, d.current = !1;
                    }, [e]),
                    isPaused: d.current,
                };
            }({ enabled: e && a, scrollSpeed: c, startDelay: 2e3, stopOnUserInteraction: !1 });
            return (0, r.useEffect)(() => {
                if (!e || !a) return;
                let t = () => {
                    n || (d.pause(), l(!0));
                };
                return window.addEventListener("wheel", t, { passive: !0 }),
                    window.addEventListener("touchstart", t, { passive: !0 }),
                    () => {
                        window.removeEventListener("wheel", t), window.removeEventListener("touchstart", t);
                    };
            }, [e, a, n, d]),
            {
                envelopeOpened: a,
                ...
                handleInvitationClick: t => {
                    if (t.target.closest("img, button, a, input, textarea, select, video, audio, dialog")) {
                        n || (d.pause(), l(!0));
                        return;
                    }
                    n ? (d.resume(), l(!1)) : (d.pause(), l(!0));
                },
                autoScrollControls: d,
            };
        }
    },
    23843: (t, e, a) => {
        ...
        let r = {
            get apiUrl() {
                return function () {
                    let t = "https://api.chungdoi.com";
                    {
                        let e = window.location.hostname;
                        if ("chungdoi.com" === e || "www.chungdoi.com" === e) return t;
                        if (e.includes("ngrok") || /^(192\.168\.|172\.(1[6-9]|2[0-9]|3[01])\.|10\.)/.test(e)) return "/backend-api";
                    }
                    return t;
                }();
            },
            baseUrl: "https://chungdoi.com",
            googleMapsApiKey: "AIzaSyAY8WQxGig6axA_jZil94btO9G6dhsFEKg",
            gaId: "G-L3F7LGNEH1",
            nodeEnv: "production",
            isDevelopment: !1,
            isProduction: !0,
    ...
    31335: (t, e, a) => {
        a.d(e, { Fi: () => d, MO: () => m, c5: () => o, do: () => f, f0: () => c, u4: () => n, uN: () => p });
        var r = a(72341);
        let s = {};
        function o(t) {
            s = { ...s, ...t };
        ...
        function n(t, e) {
            let a = { ...s, ...e };
            window.umami && window.umami.track(t, a), window.gtag && l && window.gtag("event", t, a);
            try {
                r.Ay.capture(t, a);
            } catch (t) { }
        }
        let l = "G-L3F7LGNEH1",
            ...
            d = t => {
                var e, a;
                i() && (null == (e = (a = window).gtag) || e.call(a, "set", "user_properties", t));
            },
            f = t => {
                var e, a;
                i() && (null == (e = (a = window).gtag) || e.call(a, "config", l, { user_id: null != t ? t : void 0 }));
            },
            p = t => {
                let e = "string" == typeof t ? new Date(t) : t;
                return Math.ceil(Math.abs(new Date().getTime() - e.getTime()) / 864e5);
            },
            m = t => "happy" === t.toLowerCase() ? 99 : 199;
    },
    49129: (t, e, a) => {
        a.d(e, { m: () => g });
        var r = a(95155), s = a(11518), o = a.n(s), n = a(12115), l = a(41572);
        function i(t) {
            let e = t.toLowerCase();
            return e.includes("vuonxuan") || e.includes("garden") || e.includes("floral")
                ? "petals"
                : e.includes("songlong") && !e.includes("blue") || e.includes("longphung") || e.includes("traditional")
                    || e.includes("classic")
                    ? "sparkles"
                    : "hearts";
        }
        function c(t, e) {
            let a = t.replace("#", ""),
                ...
                s = parseInt(a.substr(2, 2), 16),
                o = parseInt(a.substr(4, 2), 16);
            return "rgba(".concat(r, ", ").concat(s, ", ").concat(o, ", ").concat(e, ")");
        }
        function d(t, e) {
            let a = t.replace("#", ""),
                r = Math.max(0, parseInt(a.substr(0, 2), 16) - e),
                s = Math.max(0, parseInt(a.substr(2, 2), 16) - e),
                o = Math.max(0, parseInt(a.substr(4, 2), 16) - e);
            return "rgb(".concat(r, ", ").concat(s, ", ").concat(o, ")");
        }
        let f = {
            background: "linear-gradient(to bottom right, #fff1f2, #fce7f3, #f5d0fe)",
            ...
            dividerTo: "rgba(244, 63, 94, 0.5)",
            buttonBg: "#f43f5e",
            buttonText: "#ffffff",
            guestBoxBg: "rgba(255, 255, 255, 0.6)",
            guestBoxBorder: "rgba(244, 63, 94, 0.3)",
            dots: ["#f43f5e", "#ec4899", "#a855f7"],
            particleColors: ["#f43f5e", "#ec4899", "#a855f7", "#FFB6C1"],
            particleType: "hearts",
        },
            p = {
                songlong_red: {
                    background: "linear-gradient(to bottom right, #CD5C5C, #B54545, #8B3A3A)",
                    cardBg: "rgba(255, 248, 240, 0.95)",
                    flapBg: "#8B3A3A",
                    textPrimary: "#8B4513",
                    textSecondary: "rgba(139, 69, 19, 0.8)",
                    accent: "#FFD700",
                    buttonBg: "#FFD700",
                    buttonText: "#8B4513",
                    guestBoxBg: "rgba(139, 69, 19, 0.1)",
                    particleColors: ["#FFD700", "#FFC107", "#FF6B6B", "#FFE066"],
                },
                songlong_green: {
                    background: "linear-gradient(to bottom right, #2a4d32, #1f3a25, #152a1b)",
                    cardBg: "rgba(255, 254, 247, 0.95)",
                    flapBg: "#a8741a",
                    textPrimary: "#a8741a",
                    textSecondary: "rgba(168, 116, 26, 0.8)",
                    accent: "#d4af37",
                    buttonBg: "#d4af37",
                    buttonText: "#1f3a25",
                    guestBoxBg: "rgba(212, 175, 55, 0.15)",
                    particleColors: ["#d4af37", "#FFD700", "#ece8d6", "#a8741a"],
                },
                songlong_blue: {
                    background: "linear-gradient(to bottom right, #d8a7a7, #c99999, #b88888)",
                    cardBg: "rgba(255, 250, 250, 0.95)",
                    flapBg: "#8b6666",
                    textPrimary: "#4a3333",
                    textSecondary: "rgba(74, 51, 51, 0.8)",
                    accent: "#8b5a5a",
                    buttonBg: "#8b5a5a",
                    buttonText: "#fff5f5",
                    guestBoxBg: "rgba(255, 245, 245, 0.6)",
                    particleColors: ["#FFB6C1", "#FF69B4", "#FFC0CB", "#fff5f5"],
                },
                vuonxuan_green: {
                    ...
                    buttonBg: "#5d6a57",
                    buttonText: "#ffffff",
                    particleColors: ["#90EE90", "#98FB98", "#F0FFF0", "#bdcdc1"],
                },
                vuonxuan_red: {
                    ...
                    buttonBg: "#D25F65",
                    buttonText: "#ffffff",
                    particleColors: ["#FF6B6B", "#FFB6C1", "#FFC0CB", "#f5c4c8"],
                },
                vuonxuan_blue: {
                    ...
                    buttonBg: "#486C7D",
                    buttonText: "#ffffff",
                    particleColors: ["#87CEEB", "#B0E0E6", "#E0FFFF", "#a4c4d4"],
                },
                longphung_red: {
                    background: "linear-gradient(to bottom right, #680e0e, #4b0606, #360202)",
                    cardBg: "rgba(60, 10, 10, 0.95)",
                    flapBg: "#2a0101",
                    textPrimary: "#e9ce9e",
                    ...
                    particleColors: ["#FFD700", "#e9ce9e", "#FF6B6B", "#FFC107"],
                },
                longphung_green: {
                    background: "linear-gradient(to bottom right, #162614, #0f1a0e, #0a0f09)",
                    cardBg: "rgba(15, 25, 15, 0.95)",
                    flapBg: "#050805",
                    textPrimary: "#e9ce9e",
                    textSecondary: "rgba(233, 206, 158, 0.8)",
                    accent: "#e9ce9e",
                    ...
                    buttonText: "#0a0f09",
                    guestBoxBg: "rgba(233, 206, 158, 0.15)",
                    particleColors: ["#FFD700", "#e9ce9e", "#90EE90", "#FFC107"],
                },
                longphung_blue: {
                    background: "linear-gradient(to bottom right, #0A202F, #061420, #030a11)",
                    cardBg: "rgba(10, 25, 40, 0.95)",
                    flapBg: "#020608",
                    textPrimary: "#e9ce9e",
                    textSecondary: "rgba(233, 206, 158, 0.8)",
                    accent: "#e9ce9e",
                    ...
                    buttonText: "#030a11",
                    guestBoxBg: "rgba(233, 206, 158, 0.15)",
                    particleColors: ["#FFD700", "#e9ce9e", "#87CEEB", "#FFC107"],
                },
                anhdao_pink: {
                    ...
                    particleColors: ["#FFB6C1", "#FFC0CB", "#ffffff", "#FF69B4"],
                },
                chibi_red: {
                    background: "linear-gradient(to bottom right, #fff0f0, #ffe8e8, #ffe0e0)",
                    cardBg: "rgba(255, 255, 255, 0.95)",
                    flapBg: "#a83a3a",
                    textPrimary: "#c44d4d",
                    textSecondary: "rgba(196, 77, 77, 0.7)",
                    accent: "#c44d4d",
                    buttonBg: "#c44d4d",
                    buttonText: "#ffffff",
                    particleColors: ["#FF6B6B", "#FFB6C1", "#FFC0CB", "#FF69B4"],
                },
                thanhdiep_green: {
                    ...
                    particleColors: ["#90EE90", "#98FB98", "#4E6439", "#bdcdc1"],
                },
            },
            m = t => {
                if (!t) return null;
                try {
                    ...
                    let a = e.getDate(), r = e.getMonth() + 1, s = e.getFullYear();
                    return "".concat(a, " th\xe1ng ").concat(r, ", ").concat(s);
                } catch (t) {
                    return null;
                }
            };
        function g(t) {
            ...
            let { guestName: e, groomName: a, brideName: s, weddingDate: g, templateId: x, onOpen: u, audioRef: y } = t;
            a && "Chú Rể" !== a || (a = "Ngọc Mai");
            s && "Cô Dâu" !== s || (s = "Thành Nam");
            let [h, b] = (0, n.useState)("idle"),
                [v, w] = (0, n.useState)([]),
                [k, z] = (0, n.useState)([]),
                T = (0, n.useMemo)(() =>
                    (function (t) {
                        ...
                        if (e) {
                            ...
                            return {
                                ...
                                ...e,
                                particleType: r,
                                dots: (null == (a = e.particleColors) ? void 0 : a.slice(0, 3)) || f.dots,
                            };
                        }
                        let r = function (t) {
                            let e = l.As[t];
                            ...
                            let { colors: a } = e,
                                r = function (t) {
                                    let e = t.replace("#", ""), a = parseInt(e.substr(0, 2), 16), r = parseInt(e.substr(2, 2), 16);
                                    return (.299 * a + .587 * r + .114 * parseInt(e.substr(4, 2), 16)) / 255 < .5;
                                }(a.background),
                                s = i(t),
                                o = r ? a.text : a.primary,
                                n = c(o, .8),
                                f = r ? a.accent : a.primary,
                                p = a.background,
                                m = r ? a.secondary || a.primary : a.background;
                            return {
                                background: "linear-gradient(to bottom right, ".concat(a.primary, ", ").concat(m, ", ").concat(p, ")"),
                                cardBg: r ? c(a.background, .95) : "rgba(255, 255, 255, 0.95)",
                                flapBg: r ? d(a.primary, 30) : d(a.primary, 20),
                                textPrimary: o,
                                textSecondary: n,
                                accent: f,
                                dividerFrom: "transparent",
                                dividerTo: c(f, .5),
                                buttonBg: f,
                                buttonText: r ? a.background : "#ffffff",
                                guestBoxBg: c(r ? a.background : "#ffffff", r ? .3 : .7),
                                guestBoxBorder: c(f, .4),
                                dots: [f, a.secondary || f, a.primary],
                                particleColors: [f, a.secondary || f, a.primary, o],
                                particleType: s,
                            };
                        }(t);
                        return r || f;
                ...
                B = (0, n.useCallback)(() => {
                    let t = [];
                    for (let e = 0; e < 32; e++) {
                        let a = 2 * Math.PI * e / 32 + (Math.random() - .5) * .4, r = 25 + 60 * Math.random();
                        t.push({
                            id: e,
                            x: 50 + Math.cos(a) * r,
                            y: 50 + Math.sin(a) * r,
                            color: T.particleColors[Math.floor(Math.random() * T.particleColors.length)],
                            size: 10 + 16 * Math.random(),
                            type: "hearts" === T.particleType ? "heart" : "petals" === T.particleType ? "petal" : "sparkle",
                            rotStart: (Math.random() - .5) * 30,
                            rotEnd: (Math.random() - .5) * 360,
                            delay: .15 * Math.random(),
                        });
                    }
                    return t;
                }, [T.particleColors, T.particleType]),
                E = (0, n.useCallback)(() => {
                    let t = [];
                    for (let e = 0; e < 12; e++) {
                        t.push({
                            ...
                            x: 5 + 90 * Math.random(),
                            color: T.particleColors[Math.floor(Math.random() * T.particleColors.length)],
                            size: 10 + 14 * Math.random(),
                            type: "hearts" === T.particleType ? "heart" : "petals" === T.particleType ? "petal" : "sparkle",
                            duration: 12 + 10 * Math.random(),
                            delay: .3 * e - 2.5,
                            sway: (Math.random() - .5) * 60,
                        });
                    }
                    return t;
                }, [T.particleColors, T.particleType]),
                F = (0, n.useCallback)(() => {
                    try {
                        let t = new (window.AudioContext || window.webkitAudioContext)(), e = t.currentTime;
                        [523.25, 659.25, 783.99, 1046.5].forEach((a, r) => {
                            let s = t.createOscillator(), o = t.createGain();
                            s.connect(o), o.connect(t.destination), s.type = "sine";
                            let n = e + .1 * r;
                            s.frequency.setValueAtTime(a, n),
                                o.gain.setValueAtTime(0, e),
                                o.gain.linearRampToValueAtTime(.035 - .005 * r, n + .01),
                                o.gain.exponentialRampToValueAtTime(.001, n + 1.8),
                                s.start(n),
                                s.stop(n + 1.8);
                        }),
                            [1567.98, 2093].forEach((a, r) => {
                                let s = t.createOscillator(), o = t.createGain();
                                s.connect(o), o.connect(t.destination), s.type = "sine";
                                let n = e + .35 + .1 * r;
                                s.frequency.setValueAtTime(a, n),
                                    o.gain.setValueAtTime(0, e),
                                    o.gain.linearRampToValueAtTime(.015, n + .02),
                                    o.gain.exponentialRampToValueAtTime(.001, n + 1.2),
                                    s.start(n),
                                    s.stop(n + 1.2);
                            });
                        let a = t.createOscillator(), r = t.createGain(), s = t.createBiquadFilter();
                        a.connect(s),
                            s.connect(r),
                            r.connect(t.destination),
                            a.type = "sine",
                            a.frequency.setValueAtTime(261.63, e),
                            s.type = "lowpass",
                            s.frequency.value = 400,
                            r.gain.setValueAtTime(0, e),
                            r.gain.linearRampToValueAtTime(.025, e + .4),
                            r.gain.setValueAtTime(.02, e + 1),
                            r.gain.exponentialRampToValueAtTime(.001, e + 2.5),
                            a.start(e),
                            a.stop(e + 2.5),
                            setTimeout(() => {
                                [783.99, 987.77, 1174.66, 1567.98].forEach((e, a) => {
                                    let r = t.createOscillator(), s = t.createGain();
                                    r.connect(s), s.connect(t.destination), r.type = "sine";
                                    let o = t.currentTime + .06 * a;
                                    r.frequency.setValueAtTime(e, o),
                                        s.gain.setValueAtTime(0, t.currentTime),
                                        s.gain.linearRampToValueAtTime(.025, o + .01),
                                        s.gain.exponentialRampToValueAtTime(.001, o + .6),
                                        r.start(o),
                                        r.stop(o + .6);
                                });
                            }, 1200);
                                ...
                                children: k.map(t =>
                                    (0, r.jsx)("div", {
                                        style: {
                                            ...
                                            top: "-30px",
                                            color: t.color,
                                            fontSize: "".concat(t.size, "px"),
                                            "--sway": "".concat(t.sway, "px"),
                                            animation: "ambient-fall ".concat(t.duration, "s ease-in-out infinite"),
                                            animationDelay: "".concat(t.delay, "s"),
                                        },
                                        className: "jsx-9fed08a7f35c6a70 absolute",
                                        children: "heart" === t.type ? "❤" : "petal" === t.type ? "\uD83C\uDF38" : "✦",
                                    }, t.id)
                                ),
                            }),
                            v.length > 0 && (0, r.jsx)("div", {
                                style: { zIndex: 100 },
                                className: "jsx-9fed08a7f35c6a70 absolute inset-0 pointer-events-none",
                                children: v.map(t =>
                                    (0, r.jsx)("div", {
                                        style: {
                                            color: t.color,
                                            fontSize: "".concat(t.size, "px"),
                                            textShadow: "0 0 10px ".concat(t.color),
                                            "--dx": "".concat((t.x - 50) * 5, "px"),
                                            "--dy": "".concat((t.y - 50) * 5, "px"),
                                            "--rot-start": "".concat(t.rotStart, "deg"),
                                            "--rot-end": "".concat(t.rotEnd, "deg"),
                                            animation: "particle-burst 1.4s cubic-bezier(0.25, 0.46, 0.45, 0.94) forwards",
                                            animationDelay: "".concat(t.delay, "s"),
                                        },
                                        className: "jsx-9fed08a7f35c6a70 absolute left-1/2 top-1/2",
                                        children: "heart" === t.type ? "❤" : "petal" === t.type ? "\uD83C\uDF38" : "✦",
                                    }, t.id)
                                ),
                            }),
                            (0, r.jsx)("div", {
                                style: { zIndex: 10, animation: "away" === h ? "envelope-away 0.8s ease-in forwards" : void 0 },
                                className: "jsx-9fed08a7f35c6a70 relative",
                                children: (0, r.jsx)("div", {
                                    style: { animation: "rising" === h || "away" === h ? "card-rise 0.5s ease-out forwards" : void 0 },
                                    className: "jsx-9fed08a7f35c6a70 relative",
                                    children: (0, r.jsxs)("div", {
                                        className: "jsx-9fed08a7f35c6a70 relative w-[340px] sm:w-[380px]",
                                        children: [
                                            (0, r.jsx)("div", {
                                                style: {
                                                    height: "100px",
                                                    transformOrigin: "top center",
                                                    animation: M ? "flap-open 0.7s linear forwards" : void 0,
                                                    zIndex: 20,
                                                },
                                                className: "jsx-9fed08a7f35c6a70 absolute left-0 right-0 top-0 overflow-visible",
                                                children: (0, r.jsxs)("svg", {
                                                    viewBox: "0 0 380 100",
                                                    preserveAspectRatio: "none",
                                                    style: { filter: "drop-shadow(0 4px 6px rgba(0,0,0,0.1))" },
                                                    className: "jsx-9fed08a7f35c6a70 w-full h-full",
                                                    children: [
                                                        (0, r.jsx)("defs", {
                                                            className: "jsx-9fed08a7f35c6a70",
                                                        ...
                                                        (0, r.jsx)("path", {
                                                            d: "M 16 0 L 364 0 Q 380 0 380 16 L 380 20 L 190 100 L 0 20 L 0 16 Q 0 0 16 0 Z",
                                            ...
                                            (0, r.jsx)("div", {
                                                style: {
                                                    ...
                                                    background: "radial-gradient(circle at 30% 30%, ".concat(T.buttonBg, ", ").concat(
                                                        d(T.buttonBg, 30),
                                                        ")",
                                                    ),
                                                    "--shadow-color": c(T.buttonBg, .5),
                                                    boxShadow: "0 4px 20px ".concat(c(T.buttonBg, .5), ", inset 0 2px 4px rgba(255,255,255,0.3)"),
                                                    zIndex: 30,
                                                    animation: "idle" === h
                                                ...
                                                className:
                                                    "jsx-9fed08a7f35c6a70 absolute left-1/2 rounded-full flex items-center justify-center",
                                                children: (0, r.jsx)("svg", {
                                                    style: { fill: T.buttonText },
                                                    viewBox: "0 0 24 24",
                                                    className: "jsx-9fed08a7f35c6a70 w-7 h-7",
                                            ...
                                            M && (0, r.jsx)("div", {
                                                style: {
                                                    ...
                                                    height: "56px",
                                                    transform: "translate(-50%, -50%)",
                                                    border: "3px solid ".concat(T.buttonBg),
                                                    zIndex: 29,
                                                    animation: "seal-ring 0.6s ease-out forwards",
                                                },
                                                className: "jsx-9fed08a7f35c6a70 absolute left-1/2 rounded-full pointer-events-none",
                                            }),
                                            (0, r.jsxs)("div", {
                                                style: {
                                                    marginTop: "20px",
                                                    background: T.cardBg,
                                                    border: "1px solid ".concat(c(T.accent, .15)),
                                                },
                                                className: "jsx-9fed08a7f35c6a70 relative rounded-2xl shadow-2xl overflow-hidden",
                                                children: [
                                                    M
                                                    && (0, r.jsx)("div", {
                                                        style: {
                                                            background: "radial-gradient(ellipse at center top, ".concat(
                                                                c(T.accent, .2),
                                                                " 0%, transparent 70%)",
                                                            ),
                                                        },
                                                        className:
                                                            "jsx-9fed08a7f35c6a70 absolute inset-0 pointer-events-none transition-opacity duration-300",
                                                    }),
                                                    (0, r.jsxs)("div", {
                                                        className: "jsx-9fed08a7f35c6a70 relative text-center px-6 pt-24 pb-8",
                                                        children: [
                                                            (0, r.jsxs)("h1", {
                                                                style: {
                                                                    color: T.textPrimary,
                                                                ...
                                                                className: "jsx-9fed08a7f35c6a70 text-2xl sm:text-3xl mb-2",
                                                                children: isNgocMai
                                                                    ? [a, " & ", s]
                                                                    : [s, " & ", a],
                                                            }),
                                                    (0, r.jsxs)("div", {
                                                        className: "jsx-9fed08a7f35c6a70 flex items-center justify-center gap-3 mb-2",
                                                        children: [
                                                            (0, r.jsx)("div", {
                                                                style: {
                                                                    background: "linear-gradient(to right, transparent, ".concat(T.accent, ")"),
                                                                },
                                                                className: "jsx-9fed08a7f35c6a70 w-10 h-px",
                                                            }),
                                                            (0, r.jsx)("span", {
                                                                style: { color: T.accent, opacity: .7 },
                                                                className: "jsx-9fed08a7f35c6a70 text-sm",
                                                                children: "❦",
                                                            }),
                                                            (0, r.jsx)("div", {
                                                                style: {
                                                                    background: "linear-gradient(to left, transparent, ".concat(T.accent, ")"),
                                                                },
                                                                className: "jsx-9fed08a7f35c6a70 w-10 h-px",
                                                            }),
                                                        ],
                                                    ...
                                                    && (0, r.jsx)("p", {
                                                        ...
                                                        className: "jsx-9fed08a7f35c6a70 text-sm mb-5",
                                                        children: j,
                                                    }),
                                                    !j && (0, r.jsx)("div", { className: "jsx-9fed08a7f35c6a70 mb-5" }),
                                                    (0, r.jsxs)("div", {
                                                        className: "jsx-9fed08a7f35c6a70 mb-6",
                                                        children: [
                                                            (0, r.jsx)("p", {
                                                                style: { color: T.textSecondary },
                                                                className: "jsx-9fed08a7f35c6a70 text-sm font-light mb-2",
                                                                children: "Th\xe2n Mời",
                                                            }),
                                                            e && (0, r.jsxs)(r.Fragment, {
                                                                children: [
                                                                    (0, r.jsx)("div", {
                                                                        style: { backgroundColor: T.guestBoxBg },
                                                                        className: "jsx-9fed08a7f35c6a70 inline-block px-5 py-2.5 rounded-xl mb-2",
                                                                        children: (0, r.jsx)("h2", {
                                                                            style: { color: T.textPrimary },
                                                                            className: "jsx-9fed08a7f35c6a70 text-xl sm:text-2xl font-serif",
                                                                            children: e,
                                                                        }),
                                                                    }),
                                                                    (0, r.jsx)("p", {
                                                                        style: { color: T.textSecondary },
                                                                        className: "jsx-9fed08a7f35c6a70 text-sm font-light",
                                                                        children: "đến dự buổi tiệc chung vui c\xf9ng gia đ\xecnh",
                                                                    }),
                                                                ],
                                                            }),
                                                        ],
                                                    ...
                                                    (0, r.jsxs)("button", {
                                                        onClick: () => {
                                                            "idle" === h
                                                                && ((null == y ? void 0 : y.current) && y.current.play().catch(t => { }),
                                                                    F(),
                                                                    b("opening"),
                                                                    setTimeout(() => {
                                                                        w(B()), b("rising");
                                                        ...
                                                        style: {
                                                            ...
                                                            color: T.buttonText,
                                                            boxShadow: "0 4px 14px ".concat(c(T.buttonBg, .35)),
                                                        },
                                                        className:
                                                            "jsx-9fed08a7f35c6a70 relative px-8 py-2.5 text-base font-medium rounded-full shadow-lg transition-all duration-200 disabled:cursor-not-allowed flex items-center gap-2 mx-auto overflow-hidden hover:scale-105 active:scale-95",
                                                        children: [
                                                            "idle" !== h
                                                                ? (0, r.jsx)("span", {
                                                                    className: "jsx-9fed08a7f35c6a70 loading loading-spinner loading-sm",
                                                                })
                                                                : (0, r.jsxs)(r.Fragment, {
                                                                    children: [
                                                                        (0, r.jsx)("svg", {
                                                                            ...
                                                                            stroke: "currentColor",
                                                                            viewBox: "0 0 24 24",
                                                                            className: "jsx-9fed08a7f35c6a70 w-5 h-5",
                                                                            children: (0, r.jsx)("path", {
                                                                                strokeLinecap: "round",
                                                            ...
                                                            (0, r.jsx)("div", {
                                                                ...
                                                                className: "jsx-9fed08a7f35c6a70 absolute top-0 h-full w-8 pointer-events-none",
                                                            }),
                                                        ],
                                                    }),
                                                    (0, r.jsxs)("div", {
                                                        className: "jsx-9fed08a7f35c6a70 mt-6 flex justify-center gap-1.5 opacity-30",
                                                        children: [
                                                            (0, r.jsx)("div", {
                                                                style: { backgroundColor: T.dots[0] },
                                                                className: "jsx-9fed08a7f35c6a70 w-1.5 h-1.5 rounded-full",
                                                            }),
                                                            (0, r.jsx)("div", {
                                                                style: { backgroundColor: T.dots[1] },
                                                                className: "jsx-9fed08a7f35c6a70 w-1.5 h-1.5 rounded-full",
                                                            }),
                                                            (0, r.jsx)("div", {
                                                                style: { backgroundColor: T.dots[2] },
                                                                className: "jsx-9fed08a7f35c6a70 w-1.5 h-1.5 rounded-full",
                                                            }),
                                                        ],
                                                    }),
...
77935: (t, e, a) => {
    ...
    function s(t) {
        ...
        return (0, r.jsx)("div", {
            ...
            children: (0, r.jsx)("main", {
                ...
                children: (0, r.jsx)("div", { className: "w-full max-w-4xl", children: e }),
            }),
        });
    }
},
    79323: (t, e, a) => {
        ...
        let s = () => r.$.apiUrl;
        class o {
            static validateUTMParam(t, e) {
                if (!t) return;
                let a = t.trim();
                return a.length > e
                    && (console.warn("UTM parameter truncated from ".concat(a.length, " to ").concat(e, " characters")),
                        a = a.substring(0, e)),
                    (a = a.replace(/[<>'"]/g, "")) || void 0;
            }
            static getUTMParams() {
                let t = localStorage.getItem(this.UTM_KEY);
                if (t) {
                    try {
                        let e = JSON.parse(t);
                        if (e.timestamp && Date.now() - e.timestamp < 7776e6) return e.data;
                ...
                let e = new URLSearchParams(window.location.search),
                    a = {},
                    r = this.validateUTMParam(e.get("utm_source"), this.UTM_MAX_LENGTHS.utm_source),
                    s = this.validateUTMParam(e.get("utm_medium"), this.UTM_MAX_LENGTHS.utm_medium),
                    o = this.validateUTMParam(e.get("utm_campaign"), this.UTM_MAX_LENGTHS.utm_campaign),
                    n = this.validateUTMParam(e.get("utm_content"), this.UTM_MAX_LENGTHS.utm_content),
                    l = this.validateUTMParam(e.get("utm_term"), this.UTM_MAX_LENGTHS.utm_term);
                r && (a.utm_source = r),
                    s && (a.utm_medium = s),
                    o && (a.utm_campaign = o),
                    n && (a.utm_content = n),
                    l && (a.utm_term = l);
                let i = this.validateUTMParam(e.get("fbclid"), this.UTM_MAX_LENGTHS.fbclid),
                    c = this.validateUTMParam(e.get("gclid"), this.UTM_MAX_LENGTHS.gclid),
                    d = this.validateUTMParam(e.get("ttclid"), this.UTM_MAX_LENGTHS.ttclid);
                if (
                    i && (a.fbclid = i),
                    c && (a.gclid = c),
                    d && (a.ttclid = d),
                    !a.utm_source && !a.fbclid && !a.gclid && !a.ttclid && document.referrer
                ) {
                    let t = this.validateUTMParam(document.referrer, this.UTM_MAX_LENGTHS.referrer);
                    t && (a.referrer = t);
                }
                return Object.keys(a).length > 0
                    && localStorage.setItem(this.UTM_KEY, JSON.stringify({ data: a, timestamp: Date.now() })),
                    a;
            }
            ...
            static getToken() {
                let t = localStorage.getItem("impersonation_token");
                return t || localStorage.getItem(this.TOKEN_KEY);
            }
            static setToken(t) {
            ...
            static getUser() {
                let t = localStorage.getItem(this.USER_KEY);
            ...
            static async login(t) {
                return this.requestMagicLink({ email: t.email });
            }
            static async requestMagicLink(t) {
                let e = this.getUTMParams(),
                    a = { ...t, ...e },
                    r = await fetch("".concat(s(), "/api/auth/request-magic-link"), {
                        method: "POST",
                        headers: { "Content-Type": "application/json" },
                        body: JSON.stringify(a),
                    });
                if (!r.ok) throw Error((await r.json()).error || "Kh\xf4ng thể gửi email. Vui l\xf2ng thử lại.");
                return { message: (await r.json()).message, user: null, token: "" };
            }
            static async verifyMagicLink(t) {
                let e = await fetch("".concat(s(), "/api/auth/verify-magic-link"), {
                    method: "POST",
                    headers: { "Content-Type": "application/json" },
                    body: JSON.stringify({ token: t }),
                });
                if (!e.ok) throw Error((await e.json()).error || "Link kh\xf4ng hợp lệ hoặc đ\xe3 hết hạn.");
                let a = await e.json();
                return this.setToken(a.token), a.user && this.setUser(a.user), a;
            }
            static async verifyOTPCode(t) {
                let e = await fetch("".concat(s(), "/api/auth/verify-code"), {
                    method: "POST",
                    headers: { "Content-Type": "application/json" },
                    body: JSON.stringify(t),
                });
                if (!e.ok) throw Error((await e.json()).error || "M\xe3 kh\xf4ng hợp lệ hoặc đ\xe3 hết hạn.");
                let a = await e.json();
                return this.setToken(a.token), a.user && this.setUser(a.user), a;
            }
            static async signup(t) {
                let e = this.getUTMParams(),
                    a = await fetch("".concat(s(), "/api/auth/signup"), {
                        method: "POST",
                        headers: { "Content-Type": "application/json" },
                        body: JSON.stringify({ name: t.name, email: t.email, ...e }),
                    });
                if (!a.ok) throw Error((await a.json()).error || "Đăng k\xfd thất bại. Vui l\xf2ng thử lại sau.");
                let r = await a.json();
                return { message: r.message, user: r.user || null, token: "" };
            }
            static async logout() {
                let t = this.getToken();
                if (t) {
                    try {
                        await fetch("".concat(s(), "/api/auth/logout"), {
                            method: "POST",
            ...
            static async getCurrentUser() {
                let t = this.getToken();
                if (!t) throw Error("Chưa đăng nhập. Vui l\xf2ng đăng nhập để tiếp tục.");
                let e = await fetch("".concat(s(), "/api/auth/me"), { headers: { Authorization: "Bearer ".concat(t) } });
                if (!e.ok) {
                    if (401 === e.status) {
                        throw this.removeToken(), Error("Ph\xean đăng nhập đ\xe3 hết hạn. Vui l\xf2ng đăng nhập lại.");
                    }
                    throw Error("Kh\xf4ng thể tải th\xf4ng tin t\xe0i khoản. Vui l\xf2ng thử lại.");
                }
                let a = await e.json();
                return a.user && this.setUser(a.user), a.user;
            }
            static async authenticatedFetch(t) {
                let e = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : {}, a = this.getToken();
                if (!a) throw Error("Chưa đăng nhập. Vui l\xf2ng đăng nhập để tiếp tục.");
                let r = { ...e.headers, Authorization: "Bearer ".concat(a) }, s = await fetch(t, { ...e, headers: r });
                if (401 === s.status) throw this.removeToken(), Error("Authentication expired");
                return s;
            }
            static async devLogin(t) {
                let e = await fetch("".concat(s(), "/api/auth/dev-login"), {
                    method: "POST",
                    headers: { "Content-Type": "application/json" },
                    body: JSON.stringify({ email: t }),
                });
                if (!e.ok) throw Error((await e.json()).error || "Dev login failed");
                let a = await e.json();
                return this.setToken(a.token), a.user && this.setUser(a.user), a;
            }
            static async getDevLoginUsers(t) {
                let e = new URL("".concat(s(), "/api/auth/dev-login/users"));
                t && t.length >= 2 && e.searchParams.set("search", t);
                let a = await fetch(e.toString(), { method: "GET" });
                if (!a.ok) throw Error((await a.json()).error || "Failed to fetch users");
                return (await a.json()).users;
            }
            static async saveReferralCode(t) {
                let e = this.getToken();
                if (!e) throw Error("Chưa đăng nhập");
                let a = await fetch("".concat(s(), "/api/auth/referral-code"), {
                    method: "POST",
                    headers: { "Content-Type": "application/json", Authorization: "Bearer ".concat(e) },
                    body: JSON.stringify({ referral_code: t }),
                });
                if (!a.ok) throw Error((await a.json()).error || "Kh\xf4ng thể lưu m\xe3 giảm gi\xe1");
                return a.json();
            }
            static isAdmin(t) {
                return (null == t ? void 0 : t.role) === "admin" || (null == t ? void 0 : t.role) === "super_admin";
            }
            static isSuperAdmin(t) {
                return (null == t ? void 0 : t.role) === "super_admin";
            }
            static hasAdminAccess(t) {
                return this.isAdmin(t);
            }
        }
        o.TOKEN_KEY = "auth_token",
            o.USER_KEY = "auth_user",
            o.UTM_KEY = "utm_params",
            o.UTM_MAX_LENGTHS = {
                utm_source: 100,
                utm_medium: 100,
                utm_campaign: 255,
